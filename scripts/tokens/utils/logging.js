...
export const log = {
    ...
    warning: (msg, ...args) => console.log(`${colors.yellow}⚠ ${colors.reset}${msg}`, ...args),
    error: (msg, ...args) => console.log(`${colors.red}✗ ${colors.reset}${msg}`, ...args),
    step: (msg, ...args) => console.log(`${colors.cyan}→ ${colors.reset}${colors.bright}${msg}${colors.reset}`, ...args),
    debug: (msg, ...args) => console.log(`${colors.gray}  ${msg}${colors.reset}`, ...args),
    header: (msg) => {
        console.log(`\n${colors.magenta}${colors.bright}╭${'─'.repeat(msg.length + 2)}╮${colors.reset}`);
        console.log(`${colors.magenta}${colors.bright}│ ${msg} │${colors.reset}`);
        console.log(`${colors.magenta}${colors.bright}╰${'─'.repeat(msg.length + 2)}╯${colors.reset}\n`);
    },
};
